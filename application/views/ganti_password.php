        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                <form method="POST" action="<?php echo base_url('auth/ganti_password_action')?>">
                    <div class="form-group">
                        <div class="d-block">
                            <label for="password_baru" class="control-label">New Password</label>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <?php echo form_error('confirm_password', '<div class="text-small text-danger">', '</div>')?>
                    </div>
